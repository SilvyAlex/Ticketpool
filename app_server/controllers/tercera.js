...
const tercera = (req, res, next)=> {
  ...
  axios.request(config)
    .then((response) => {
      ...
      res.render('tercera', { title: 'Mi tercera página Express', evento: evento });
    })
    .catch((error) => {
      console.log(error);
      ...
      res.render('tercera', { title: 'Mi tercera página Express', evento: null, error: 'No se pudo obtener la información del evento.' });
    });
  }
